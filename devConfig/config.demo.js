let config = {
    ...
    proxyTable:{
        "/spoc-choiceschool":{
            target: 'http://39.107.224.42:8181',
            pathRewrite: {
                "^/spoc-choiceschool":"/spoc-choiceschool",
            }
        },
        "/spoc-search": {
            target: 'http://39.107.224.42:8182',
            pathRewrite: {
                "^/spoc-search": "/spoc-search",
            }
        },
        "/spoc-contract":{
            target:'http://39.107.224.42:8183',
            pathRewrite: {
                "^/spoc-contract": "/spoc-contract",
            }
        },
        "/spoc-common":{
            target:'http://39.107.224.42:8185',
            pathRewrite: {
                "^/spoc-common": "/spoc-common",
            }
        },
        "/spoc-plan":{
            target:'http://39.107.224.42:8186',
            pathRewrite: {
                "^/spoc-plan": "/spoc-plan",
            }
        },
        "/spoc-docu":{
            target:'http://39.107.224.42:8188',
            pathRewrite: {
                "^/spoc-docu": "/spoc-docu",
            }
        },
        "/spoc-crm":{
            target:'http://39.107.224.42:8189',
            pathRewrite: {
                "^/spoc-crm": "/spoc-crm",
            }
        },
        "/spoc-apply":{
            target:'http://39.107.224.42:8190',
            pathRewrite: {
